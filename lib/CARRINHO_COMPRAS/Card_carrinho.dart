...
class Cards_carrinho extends StatefulWidget {
  @override
  _Cards_carrinhoState createState() => _Cards_carrinhoState();

  Cards_carrinho({this.curso,this.imagem,this.preco,this.id});
...
class _Cards_carrinhoState extends State<Cards_carrinho> {
